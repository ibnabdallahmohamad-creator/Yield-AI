  ...
  return (
    <DialogPrimitive.Portal>
      <DialogPrimitive.Overlay
        ...
        className="fixed inset-0 z-50 bg-black/25 duration-100 supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0"
      />
