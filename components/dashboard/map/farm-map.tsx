...
/**
 * Name tag with the compare delta (e.g. "ECe +18%"): above a field's north edge when zoomed in,
...
const FieldLayer = memo(function FieldLayer({
  ...
  const hoverValue = metric.spatial ? cursor : farm.value;
          ...
          <div className="tabular text-muted-foreground">
            {hasData ? (
              <>
                ...
                {metric.spatial && cursor != null ? " · interpolated here" : ""}
              </>
            ) : (
